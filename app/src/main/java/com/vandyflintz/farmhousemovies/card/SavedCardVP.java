...
import com.vandyflintz.farmhousemovies.CardOrNumberActivity;
...
//        dismissDialog();
    ...
    public void chargeCard(final Payload payload, final String secretKey, final Activity activity) {
        ...
        com.vandyflintz.farmhousemovies.card.ChargeRequestBody body = new com.vandyflintz.farmhousemovies.card.ChargeRequestBody();
