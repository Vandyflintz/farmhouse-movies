 ...
 * Use the {@link Series_Sub_Expired_Episodes#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Series_Sub_Expired_Episodes extends Fragment {
    ...
    public Series_Sub_Expired_Episodes() {
     ...
     * @return A new instance of fragment Series_Sub_Expired_Episodes.
     */
    // TODO: Rename and change types and number of parameters
    public static Series_Sub_Expired_Episodes newInstance(String param1, String param2) {
        Series_Sub_Expired_Episodes fragment = new Series_Sub_Expired_Episodes();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_series__sub__expired__episodes, container,
                false);
        //type=season
    ...
    private void getrecords(int pagenum, String device) {
        ...
        JsonArrayRequest movieReq =
                new JsonArrayRequest(" http://192.168.43.189/farmhousemovies/api/subscriptions_records" +
                        ".php?user="+userid +"&device="+device+"&page="+pagenum+"&type=season" +
                        "&secs=episodes&status=expired",
