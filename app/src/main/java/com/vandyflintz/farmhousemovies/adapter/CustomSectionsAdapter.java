...
public class CustomSectionsAdapter extends BaseAdapter {
    ...
    public CustomSectionsAdapter(Activity activity, List<Movie> movieItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.seasoninfo, null);
