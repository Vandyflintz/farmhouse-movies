...
import static com.vandyflintz.farmhousemovies.thetellerConstants.theteller;
import static com.vandyflintz.farmhousemovies.thetellerConstants.theteller_PARAMS;
import static com.vandyflintz.farmhousemovies.thetellerConstants.theteller_REQUEST_CODE;

public class thetellerManager {
    private String email;
    private double amount = -1;
    private String apiKey, activityname;
    ...
    public thetellerManager setActivityName(String activityname) {
    ...
    public thetellerInitializer createthetellerInitializer() {
        return new thetellerInitializer(email, amount, apiKey, apiUser, txRef, narration,
                currency, merchant_id, terminal_id, voucher_code, fName, lName, withCard,
                withGHMobileMoney, d_response_url, theme, staging, allowSaveCard, meta,
                payment_plan, activityname);
    }
}