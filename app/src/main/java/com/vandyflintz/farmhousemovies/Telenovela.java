 ...
 * Use the {@link Telenovela#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Telenovela extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
     ...
     * @return A new instance of fragment Telenovela.
     */
    // TODO: Rename and change types and number of parameters
    public static Telenovela newInstance(String param1, String param2) {
        Telenovela fragment = new Telenovela();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_telenovela, container, false);

        listView = (ListView) v.findViewById(R.id.listmovies);
        adapter = new CustomListAdapter(getActivity(), movieList);
        listView.setAdapter(adapter);
        emptyText = v.findViewById(R.id.emptytext);
        swipeRefreshLayout = v.findViewById(R.id.telefrag);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (info.matches("")) {
                    ...
                    TelenovelaAnnex fg = new TelenovelaAnnex();
