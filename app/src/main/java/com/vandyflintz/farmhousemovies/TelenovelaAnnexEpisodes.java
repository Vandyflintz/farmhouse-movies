 ...
 * Use the {@link TelenovelaAnnexEpisodes#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TelenovelaAnnexEpisodes extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public TelenovelaAnnexEpisodes() {
     ...
     * @return A new instance of fragment TelenovelaAnnexEpisodes.
     */
    // TODO: Rename and change types and number of parameters
    public static TelenovelaAnnexEpisodes newInstance(String param1, String param2) {
        TelenovelaAnnexEpisodes fragment = new TelenovelaAnnexEpisodes();
    ...
    static String urlresult, userid, finalfilename;
    ...
    String walletnum;
    String vouchernum;
    String phonenum, pstatus, servermsg;
    static String totalprice, category, moviename, sid, availability;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_telenovela_annex_episodes, container, false);
        ...
        swipeRefreshLayout = v.findViewById(R.id.telenovelaannexfrag);
        ...
        allsubbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showpaymentdialog("SeriesFull", movieid, sid, "", userid,totalprice,
                        moviename);
            }
        });
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String lfrag = "telenovelaepisodes";
                int lpos = position;
                if(moviefile.matches("")){
                    ...
                    if(paidstatus.getVisibility() == View.VISIBLE){
                        ...
                        mListener.onteleFragmentInteraction(moviefile, finalname, moviepath, partid,
    ...
    private static void getrefreshedrecords(int totalitems) {
        ...
        String url = "http://192.168.43.189/farmhousemovies/api//getrefreshedresults" +
                ".php?id="+movieid+"&seriesid="+seasonid+
                "&user="+userid+
                "&rtype=series&items="+totalitems;
                                ...
                                if(response.length()>0){
                                    ...
                                    for (int i = 0; i < response.length(); i++) {
                                        try {
                                            ...
                                            JSONObject objcount = response.getJSONObject(0);
                                            Movie movie = new Movie();
                                            title.setText(objcount.getString("title")+" - "+obj.getString("seriesname"));
                                            movie.setSeriesName(obj.getString("seriesname"));
                                            movie.setSeriesID(obj.getString("seriesid"));
                                            movie.setPartname(obj.getString("partname"));
                                            movie.setSeriesShortName(obj.getString(
    ...
    private void validateEntries() {
        ...
        if (valid) {
            ((Home)getActivity()).setactivityname("TeleAnnex","fragment");
...
//        voucherCode = findViewById(R.id.voucherCodeEt);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof TelenovelaAnnexEpisodes.OnTeleFragmentInteractionListener) {
            mListener = (TelenovelaAnnexEpisodes.OnTeleFragmentInteractionListener) context;
        } else {
            throw new RuntimeException(context.toString()
                    + " must implement OnTeleFragmentInteractionListener");
        }
    }
    ...
    public interface OnTeleFragmentInteractionListener {
        ...
        void onteleFragmentInteraction(String data, String title, String path, String partid,
                                       String partdate, String moviedesc, String favstatus, String movietype, String sid, String subscription, String movieid, String lfrag, int lpos, String expiryDate, String meprice);
    }
