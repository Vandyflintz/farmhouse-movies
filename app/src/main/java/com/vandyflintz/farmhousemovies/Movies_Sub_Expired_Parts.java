 ...
 * Use the {@link Movies_Sub_Expired_Parts#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Movies_Sub_Expired_Parts extends Fragment {
    ...
    public Movies_Sub_Expired_Parts() {
     ...
     * @return A new instance of fragment Movies_Sub_Expired_Parts.
     */
    // TODO: Rename and change types and number of parameters
    public static Movies_Sub_Expired_Parts newInstance(String param1, String param2) {
        Movies_Sub_Expired_Parts fragment = new Movies_Sub_Expired_Parts();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_movies__sub__expired__parts, container, false);
    ...
    private void getrecords(int pagenum, String device) {
        ...
        JsonArrayRequest movieReq =
                new JsonArrayRequest(" http://192.168.43.189/farmhousemovies/api/subscriptions_records" +
                        ".php?user="+userid +"&device="+device+"&page="+pagenum+"&type=single" +
                        "&secs=parts&status=expired",
