...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    private void setResultOk(Uri imagePath) {
        String filename = getFileNameByUri(ImagePickerActivity.this, imagePath);
    ...
    private Uri getCacheImagePath(String fileName) {
        ...
        Uri uriForFile = getUriForFile(ImagePickerActivity.this, getPackageName() + ".provider", image);
        return uriForFile;
    }
