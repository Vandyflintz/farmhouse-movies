 ...
 * {@link SeasonAnnex.OnSeasonFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SeasonAnnex#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SeasonAnnex extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
     ...
     * @return A new instance of fragment SeasonAnnex.
     */
    // TODO: Rename and change types and number of parameters
    public static SeasonAnnex newInstance(String param1, String param2) {
        SeasonAnnex fragment = new SeasonAnnex();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_season_annex, container, false);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (movieid.matches("") || seasonid.matches("")) {
                    ...
                    SeasonAnnexEpisodes fg = new SeasonAnnexEpisodes();
                    FragmentManager fm = getFragmentManager();
                    FragmentTransaction trans = fm.beginTransaction();
                    Bundle scanresbundle = new Bundle();
                    scanresbundle.putString("MovieID",
                            "http://192.168.43.189/farmhousemovies/api/seasons_and_series" +
                                    ".php?id=" + movieid+"&seasonid="+seasonid+
                                    "&type=Season");
                    scanresbundle.putString("urlrf",
                            "http://192.168.43.189/farmhousemovies/api/getrefreshedresults" +
                                    ".php?id=" + movieid+"&seasonid="+seasonid+
                                    "&rtype=season");
                    scanresbundle.putString("MID", movieid);
                    scanresbundle.putString("SID", seasonid);
                    fg.setArguments(scanresbundle);
                    trans.add(fg, "seasannex");
                        ...
                        if(response.length()>0){
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                try {
                                    ...
                                    movie.setTitle(obj.getString("seasonname"));
                                    movie.setYear("");
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnSeasonFragmentInteractionListener) {
          //  mListener = (OnSeasonFragmentInteractionListener) context;
        } else {
