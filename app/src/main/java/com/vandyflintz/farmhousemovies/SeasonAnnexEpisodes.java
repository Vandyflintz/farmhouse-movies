 ...
 * Use the {@link SeasonAnnexEpisodes#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SeasonAnnexEpisodes extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
     ...
     * @return A new instance of fragment SeasonAnnexEpisodes.4
     */


    private OnSeasonFragmentInteractionListener mListener;

    // TODO: Rename and change types and number of parameters
    public static SeasonAnnexEpisodes newInstance(String param1, String param2) {
        SeasonAnnexEpisodes fragment = new SeasonAnnexEpisodes();
    ...
    static String urlresult, userid, finalfilename, availability, newurl;
    public static String movieid, seasonid;
    Button button;
    ...
    String finalcode, servermsg;
    public boolean detailsexist = false;
    public boolean movetonextscreen = false;
    static String totalprice, category, moviename,  partid, sid;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_season_annex_episodes, container, false);
        ...
        newurl = getArguments().getString("urlrf");
        movieid = getArguments().getString("MID");
        seasonid = getArguments().getString("SID");
        ...
        swipeRefreshLayout = v.findViewById(R.id.seasonannexfrag);
        ...
        allsubbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showpaymentdialog("SeasonFull", movieid, sid, "", userid,totalprice,
                        moviename);
            }
        });
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                TextView textView10 = ((TextView)view.findViewById(R.id.shname));
                ...
                if(moviefile.matches("")){
                    ...
                    if(paidstatus.getVisibility() == View.VISIBLE){
                        ...
                        mListener.onseasonFragmentInteraction(moviefile, finalname, moviepath, partid,
                                partdate,  moviedesc, favistatus, movietype, sid, subscription,
                                movieid, lfrag, lpos, expiryDate, meprice);
    ...
    private static void getrefreshedrecords(int totalitems) {
        ...
        JsonArrayRequest movieReq = new JsonArrayRequest(newurl+"&user="+userid+
                "&items="+totalitems,
    ...
    private void getrecords(int pagenum, String device, String request) {
        ...
        JsonArrayRequest movieReq =
                new JsonArrayRequest(urlresult+"&user="+userid+"&page="+pagenum+
                                ...
                                if(response.length()>0){
                                    ...
                                    for (int i = 0; i < response.length(); i++) {
                                        try {
                                            ...
                                            Movie movie = new Movie();
                                            progressBar.setVisibility(View.INVISIBLE);
                                            title.setText(objcount.getString("title")+" - "+obj.getString("seasonname"));
                                            movie.setSeriesName(obj.getString("seasonname"));
                                            movie.setSeriesID(obj.getString("seasonid"));
                                            movie.setPartname(obj.getString("partname"));
                                            movie.setSeriesShortName(obj.getString(
                    ...
                    public void onErrorResponse(VolleyError error) {
                        VolleyLog.d(TAG, "Error: " + error.getMessage());
                        Log.d(TAG, "Season Annex Error: " + error.getMessage());
                        progressBar.setVisibility(View.INVISIBLE);
                        final Handler searchhandler = new Handler();
                        searchhandler.postDelayed(new Runnable() {
                            @Override
    ...
    private static void displaybtn() {
        if(!category.equalsIgnoreCase("free") || !availability.equalsIgnoreCase("unavailable")){
    ...
    private void saveRecordDetails(String moviename, String seasonname, String episodename){
        new PreferencesManager(getActivity()).saveRecordDetails(moviename,seasonname,episodename);
    }

    private void showpaymentdialog(String mtype, String movieid, String sid, String partid,
                                   String userid, String mPrice,String mName) {
        ...
        apiUserEt.setText("farmhousemovies5f32b9f237fe6");
...
//        voucherCode = findViewById(R.id.voucherCodeEt);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(walletnum.length()==0 || walletnum.equalsIgnoreCase("-- Select Wallet --")){
                    ...
                    alertDialog.getButton(AlertDialog.BUTTON_NEGATIVE).setVisibility(View.GONE);
                    new AsyncPay().execute(phonenum,walletnum,amt,mtype,movieid,partid, sid,
                            userid);
                }
            }
        });
    ...
    private void validateEntries() {
        ...
        if (valid) {
            ((Home)getActivity()).setactivityname("SeasAnnex","fragment");
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof SeasonAnnexEpisodes.OnSeasonFragmentInteractionListener) {
            mListener = (SeasonAnnexEpisodes.OnSeasonFragmentInteractionListener) context;
        } else {
     ...
     */
    public interface OnSeasonFragmentInteractionListener {
        // TODO: Update argument type and name
        void onseasonFragmentInteraction(String data, String title, String path, String partid,
                                         String partdate, String moviedesc, String favstatus,
                                         String movietype, String sid, String subscription, String movieid, String lfrag, int lpos, String expiryDate, String meprice);
    }
