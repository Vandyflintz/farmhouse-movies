...
import com.vandyflintz.farmhousemovies.card.ChargeRequestBody;
...
//        Call<ChargeResponse> call = service.charge(body);
    ...
    @Override
    public void chargeMomo(Payload payload, com.vandyflintz.farmhousemovies.ghmobilemoney.ChargeRequestBody body, final Callbacks.OnChargeRequestComplete callback) {
